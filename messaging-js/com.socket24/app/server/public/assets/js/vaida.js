...
// STATIC VARIABLES
//==============================================================================
    com.socket24.ConnectionManager.DEFAULT_READY_TIMEOUT = 600000;
...
//==============================================================================
    ...
    com.socket24.SnapshotManager.prototype.receiveSnapshotResult = function (requestID, status) {
        ...
        console.warn(":::::::::::::::::::this.pendingSnapshots", this.pendingSnapshots);
...
//==============================================================================
    ...
    com.socket24.SnapshotManager.prototype.receiveRoomSnapshot = function (requestID, manifest) {
        ...
        console.warn(":::::::::::::::::::requestID, manifest, this.pendingSnapshots", requestID, manifest, this.pendingSnapshots);
...
//==============================================================================
    com.socket24.Connection.prototype.setServer = function (host, port) {
